...
public class Constantes {
	// AÇÔES
		...
		public static final String USUARIO_ESTÃO_DESATIVADO = " Usuário estão desativado";
		public static final String USUARIO_ESTÃO_ATIVADO = " Usuário estão ativado";
		...
		// PERSISTENCE_UNITE
		public static final String PERSISTENCE_UNIT_NAME = "ROQUE";
}
